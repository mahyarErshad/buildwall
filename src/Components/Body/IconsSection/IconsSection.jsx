...
function IconsSection() {
  ...
  return (
    <section className="py-20 flex-center flex-col w-full bg-white px-4 gap-4">
      <h2 className="text-center text-3xl font-bold text-secondary">مجموعه بزرگی از فونت آیکون</h2>
      <p className="text-sm text-center text-secondary"> وب سایت خود را با هزاران آیکون جذاب که مخصوص این قالب ایجاد شده اند، تجهیز کنید! این آیکون ها گل سر سبد وب سایت شما خواهند بود! </p>
