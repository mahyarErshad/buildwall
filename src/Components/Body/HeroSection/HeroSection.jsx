  ...
  return (
    <section className={`${styles.wrapper} w-full h-full`}>
      <article className="mx-auto pt-20 flex-center flex-col gap-4">
        <TypeAnimation className="font-bold text-secondary text-3xl" sequence={["قالب شرکتی ساختمانی بیلدوال", 3000, "قالب یکپارچه برای انواع سایت های شرکتی!", 3000, , "قالب یکپارچه برای انواع مشاغل ساختمانی!", 3000]} speed={50} deletionSpeed={80} wrapper="h1" repeat={Infinity} />
