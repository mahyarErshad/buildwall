  ...
  return (
    <section className={`${styles.wrapper} w-full h-full`}>
      <article className="mx-auto pt-20 flex-center flex-col gap-4">
        <h1 className="font-bold text-customBlack text-3xl">تم یکپارچه برای انواع مشاغل ساختمانی!</h1>
        <p className="text-xl text-customBlack">کسب و کار خود را با عملکرد باورنکردنی و رابط کاربری کارآمد تقویت کنید!</p>
